...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 pt-24 pb-12 flex gap-8">
        ...
        <div className="w-full md:w-80 shrink-0 space-y-4 hidden md:block">
          ...
          <ScrollArea className="h-[calc(100vh-200px)] rounded-xl border bg-white/50 backdrop-blur-sm shadow-sm">
            <div className="p-4 space-y-3">
              {loading ? (
                ...
                trips.map((trip) => (
                  <div
                    key={trip._id}
                    onClick={() => setSelectedTrip(trip.tripDetails)}
                    className={cn(
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="md:hidden mb-6 flex justify-between items-center">
            ...
            <Button size="sm" onClick={() => navigate("/plan")}>
              <PlusCircle className="h-4 w-4 mr-2" /> New Trip
            </Button>
          </div>
